              ...
              <div className="container">
                ...
                <div className="py-8 md:py-10 lg:py-12">
                  <div className="grid grid-cols-1 gap-y-12 md:items-center md:gap-x-12 lg:grid-cols-2 lg:gap-x-20">
                    <div>
                      <p className="mb-3 font-semibold md:mb-4">Mindset</p>
                      <h2 className="heading-h2 mb-5 font-bold md:mb-6">
                        Build your financial foundation
                      </h2>
                      <p className="text-medium">
                        Control your emotions. Develop discipline. Stop making
                        impulsive decisions that cost money.
                      </p>
            ...
            <div className="px-[5%]">
              <div className="container">
                <a href="#" className="flex h-16 w-full items-center underline">
                  ...
                  <h1 className="text-medium font-semibold">Risk management</h1>
                </a>
                <div className="py-8 md:py-10 lg:py-12">
                  <div className="grid grid-cols-1 gap-y-12 md:items-center md:gap-x-12 lg:grid-cols-2 lg:gap-x-20">
                    <div>
