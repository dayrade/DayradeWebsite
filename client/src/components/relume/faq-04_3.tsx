      ...
      <div className="container max-w-lg">
        <div className="mb-12 text-center md:mb-18 lg:mb-20">
          ...
          <p className="text-medium">
            Learn about our commitment to security, data protection, and fair
            play.
          </p>
        </div>
        <Accordion
        ...
        >
          <Card>
            <AccordionItem value="item-0" className="border-none px-5 md:px-6">
              ...
              <AccordionContent className="md:pb-6">
                Absolutely. We use 256-bit encryption and comply with
                international data protection standards. Your information
          ...
          <Card>
            <AccordionItem value="item-1" className="border-none px-5 md:px-6">
              ...
              <AccordionContent className="md:pb-6">
                Our real-time anti-cheat system monitors all activity. KYC
                verification ensures one account per person, with immediate
                flagging of suspicious behavior.
              </AccordionContent>
            </AccordionItem>
          </Card>
          <Card>
