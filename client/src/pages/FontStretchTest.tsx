        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-8 mb-8 shadow-lg">
          ...
          <div className="mb-6 flex gap-4">
            <button
              ...
              className="px-6 py-2 bg-primary text-primary-foreground rounded-lg hover-elevate active-elevate-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isAnimating ? 'Animating...' : 'Animate'}
            </button>
            <button
              onClick={() => setStretch(100)}
              className="px-6 py-2 bg-secondary text-secondary-foreground rounded-lg hover-elevate active-elevate-2"
            >
              Reset
            </button>
          </div>
