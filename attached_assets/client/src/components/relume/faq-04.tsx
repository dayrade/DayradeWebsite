      ...
      <div className="container max-w-lg">
        <div className="mb-12 text-center md:mb-18 lg:mb-20">
          ...
          <p className="text-medium">
            Your guide to understanding DAYRADE and getting started on your
            trading journey.
          </p>
        </div>
        <Accordion
        ...
        >
          <Card>
            <AccordionItem value="item-0" className="border-none px-5 md:px-6">
              ...
              <AccordionContent className="md:pb-6">
                Click "Sign Up Now" and follow our streamlined onboarding.
                Create your unique spirit animal, build your profile, and be
          ...
          <Card>
            <AccordionItem value="item-1" className="border-none px-5 md:px-6">
              ...
              <AccordionContent className="md:pb-6">
                Registration is free. The Elevator Division offers free entry.
                Advanced divisions require tickets purchasable through rewards
                or direct buy.
              </AccordionContent>
            </AccordionItem>
          </Card>
          <Card>
            <AccordionItem value="item-2" className="border-none px-5 md:px-6">
              ...
              <AccordionContent className="md:pb-6">
                KYC ensures fair play by verifying user identity. It prevents
                multiple accounts and is mandatory for tournament participation
                and prize withdrawals.
              </AccordionContent>
            </AccordionItem>
          </Card>
          <Card>
