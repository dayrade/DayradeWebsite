        ...
        <div className="mx-auto max-w-lg">
          <div className="mb-14 flex flex-col gap-y-8 sm:flex-row sm:items-center sm:justify-between md:mb-16 md:gap-y-0">
            <Breadcrumb className="flex items-center">
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator />
                <BreadcrumbItem>
                  <BreadcrumbLink href="#">Trading</BreadcrumbLink>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          ...
          <div>
            <div className="mb-8 text-center md:mb-10 lg:mb-12">
              <p className="text-medium font-semibold">Share this lesson</p>
          ...
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <div className="grow">
              <p className="text-medium font-semibold">Jack Thompson</p>
              <p>Lead trader, DAYRADE</p>
            </div>
          </div>
        </div>
      </div>
